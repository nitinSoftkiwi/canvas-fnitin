...
// const Text = () => (
//   <div>
//         <div class="moveable" style={{ width: '100%', height: '100%', cursor: 'move' , color:'white' }}><span >Moveable</span></div>
        ...
        <div className={scrollbar.customScroll}>
          <div className={styles.textDrawer}>
            ...
            <div className={styles.highlights}>
              <div className={`${styles.highlightItem} ${styles.heading}`}  onClick={() => this.addElement(mockupResponse[0])} house={this.state.house}>
                <p>Add a heading</p>
              </div>
